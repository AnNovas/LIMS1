...
CREATE TABLE `analyticaldata` (
  ...
  `AnDataName` varchar(45) DEFAULT NULL,
  `AnDataSN` varchar(45) DEFAULT NULL,
  `ADUnits` varchar(45) DEFAULT NULL,
  `ADUnitsSN` varchar(45) DEFAULT NULL,
...
CREATE TABLE `equiptype` (
  ...
  `ETypeName` varchar(45) DEFAULT NULL,
...
CREATE TABLE `literature` (
  ...
  `LitName` varchar(45) DEFAULT NULL,
...
CREATE TABLE `methodology` (
  ...
  `MetName` varchar(45) DEFAULT NULL,
  `Meth_text` longtext,
  `Experiment_idExperiment` int NOT NULL,
...
CREATE TABLE `parameters` (
  ...
  `ParName` varchar(45) DEFAULT NULL,
  `ParSN` varchar(45) DEFAULT NULL,
  `ParUnits` varchar(45) DEFAULT NULL,
  `ParUnitsSN` varchar(45) DEFAULT NULL,
...
INSERT INTO `personnel` VALUES (1,'Мочалова М.',NULL,'mochalova82','mochalova82',2),(2,'Суслова Е.',NULL,'suslova54','suslova54',2),(3,'Цыганков П.',NULL,'tsygankov43','tsygankov43',2),(4,'Уварова А.',NULL,'uvarova21','uvarova21',2),(5,'Комарова Д.',NULL,'komarova26','komarova26',1),(6,'Дёмкин К.',NULL,'demkin44','demkin44',1),(7,'Пилоян А.',NULL,'piloyan28','piloyan28',1),(8,'Платонов Д.',NULL,'platonov84','platonov84',1),(9,'Сорокин С',NULL,'sorokin72','sorokin72',1),(10,'КорнеевД.',NULL,'korneev45','korneev45',1),(11,'Березовская Е.',NULL,'berezovskaya32','berezovskaya32',1),(12,'Голубев Э.',NULL,'golubev65','golubev65',1),(13,'Агафонова А.',NULL,'agafonova31','agafonova31',1),(14,'Черевко С.',NULL,'cherevko49','cherevko49',1),(15,'Прописнова А.',NULL,'propisnova18','propisnova18',1),(16,'Лебедева М.',NULL,'lebedeva77','lebedeva77',1),(17,'Трофимова К.',NULL,'trofimova11','trofimova11',1),(18,'Васютина А.','Главный','god1000','god1000',2),(19,'Васютина А','Дурачок','ivan20','ivan20',1);
...
CREATE TABLE `physchemproperties` (
  ...
  `PropSN` varchar(45) DEFAULT NULL,
  `PrUnits` varchar(45) DEFAULT NULL,
  `PrUnitSN` varchar(45) DEFAULT NULL,
...
CREATE TABLE `processstage` (
  ...
  `PSName` varchar(45) DEFAULT NULL,
...
CREATE TABLE `reagent` (
  ...
  `CatNumber` varchar(45) DEFAULT NULL,
  `DateReceived` date DEFAULT NULL,
...
INSERT INTO `reagent` VALUES (1,'Хитозан','2022-09-08','2024-09-08',250,20,1,1,1,1,1),(2,'Белок молочный','2022-07-08','2024-07-08',300,20,1,1,1,2,2),(3,'Белок яичный','2022-02-03','2024-02-03',500,20,1,1,1,4,3),(4,'Альгинат натрия','2022-07-07','2024-07-07',400,20,1,1,1,1,4),(5,'Тетраэтоксисилан','2022-05-03','2025-05-03',450,20,1,1,1,3,5),(6,'Дистилированная вода','2022-02-05','2025-02-05',10,2,1,4,3,2,6),(7,'Уксусная кислота','2022-04-05','2024-04-05',2,1,1,2,2,3,7),(8,'Гидроксид натрия','2022-06-02','2024-06-02',500,20,1,1,2,2,8),(9,'Изопропиловый спирт','2022-04-03','2024-04-03',2,1,1,2,2,4,9),(10,'Аммиак','2022-05-05','2024-05-05',500,20,1,3,2,3,10),(11,'Соляная кислота','2022-03-09','2024-03-09',500,20,1,3,2,1,11),(12,'Хлорид кальция','2022-01-08','2023-07-08',200,20,1,1,2,2,12),(13,'Этиловый спирт','2022-05-09','2024-05-09',3,1,1,2,3,3,13),(14,'Ацетон','2022-01-02','2023-07-22',2,1,1,2,3,2,14),(15,'Гексан','2000-01-01','2023-07-16',2,1,1,2,3,1,15),(16,'Ацетонитрил','2000-01-01','2023-06-27',3,1,1,2,2,2,16),(17,'ДМСО','2000-01-01','2025-04-04',4,1,1,3,2,3,17),(18,'Крахмал','2000-01-01','2023-07-29',500,1,1,6,1,1,18),(19,'Желатин','2000-01-01','2024-11-01',500,20,1,1,1,2,19),(20,'Коллаген','2000-01-01','2023-07-04',20,5,1,1,1,3,20),(21,'Лидокаин','2000-01-01','2025-06-01',100,5,1,1,4,3,21),(22,'Гиалуроновая кислота','2000-01-01','2029-03-03',200,20,1,1,1,1,22),(23,'ывыацо','2022-02-04','2027-03-04',200,20,0,1,1,1,1);
...
CREATE TABLE `reaginfo` (
  ...
  `ReagName1` varchar(45) DEFAULT NULL,
  `ReagName2` varchar(45) DEFAULT NULL,
  `ReagName3` varchar(45) DEFAULT NULL,
  `ReagNameENG` varchar(45) DEFAULT NULL,
  `ReagFormula` varchar(45) DEFAULT NULL,
  `CodeReag` varchar(45) DEFAULT NULL,
...
CREATE TABLE `reagtype` (
  ...
  `RTypeName` varchar(45) DEFAULT NULL,
...
CREATE TABLE `researchproject` (
  ...
  `RPName` varchar(45) DEFAULT NULL,
...
INSERT INTO `researchproject` VALUES (1,'Хитозанове аэрогели',0),(2,'Земля за 6 дней',1),(3,'Печка на своем ходу',1),(4,'Украсть царевну',1);
...
INSERT INTO `researchproject_has_personnel` VALUES (1,1,1,1),(2,1,2,18),(3,1,3,19),(4,1,4,19);
...
INSERT INTO `status_rp` VALUES (1,'Исполнитель'),(2,'Ассистент'),(3,'Научный руководитель');
...
CREATE TABLE `stockstatus` (
  ...
  `StatName` varchar(45) DEFAULT NULL,
...
CREATE TABLE `units` (
  ...
  `UUnitSN` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`idUnits`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb3;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `units` VALUES (1,'Граммы','г'),(2,'Литры','л'),(3,'Миллилитры','мл'),(4,'Пять литров','5л'),(5,'Количество штук','шт'),(6,'Килограмм','кг');
...
-- Dump completed on 2023-06-14 10:24:14
